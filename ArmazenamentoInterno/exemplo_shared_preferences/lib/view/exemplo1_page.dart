...
class _Exemplo1PageState extends State<Exemplo1Page> {
  ...
  _salvarNomeShared() async{ // Conexão async (asincrona) permite continuar rodadno o código enquanto é feito a conexão com a base de dados
  ...
  // Inicio da página
  @override // Método que é iniciado, antes mesmo do build da tela 
